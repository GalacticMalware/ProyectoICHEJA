...
<div>	
	<div id="logos">
		...
		<br>
		<br>
		<hr width="1010px" size="5px" >

<div id="Nota">
	<div class="Span4 nota1">
		<form action="">
			<h4>
...
<div id="login">
	<div class="Span4 login1">
		<form action="validarAdmin.php" method="POST">
		<h2>Login</h2>
		<input type="text" placeholder="&#128272; USUARIO" name="usuarioAdmin" required>
		<input type="password" placeholder="&#128272; CONTRASEÑA" name="claveAdmin" required>
		<input type="submit" value="INGRESAR">

	</form>
	</div>
</div>
<a href="indexasesor.php" style="margin: auto; margin-left: 750px;">Regresar</a>
