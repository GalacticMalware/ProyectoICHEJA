...
$_SESSION['clave'] = $clave;
$_SESSION['asesor'] = $claveAsesor; 
//$materi = "quimica";
//$claveAsesor= SED::encryption($claveAsesor);
$clave=SED::encryption($clave);

$consultaUsuario="SELECT * FROM alumno WHERE num_control='$usuario' AND password = '$claveAsesor'";
$consultaAsesor="SELECT * FROM asesor WHERE RFC='$usuario' AND password = '$clave'";
$consultaAdmin="SELECT * FROM administrador WHERE RFC='$usuario' AND Password = '$claveAsesor'";
